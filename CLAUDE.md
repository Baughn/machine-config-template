...
- Give a basic overview and explanation of the purpose of this repository, and the process you're about to start. Simultaneously, ask the user for the purpose of this machine, their name, their email (for Jujutsu).
...
- Check the GPU type with `./tools-for-claude/lspci.sh`. Import modules/nvidia.nix if applicable.
